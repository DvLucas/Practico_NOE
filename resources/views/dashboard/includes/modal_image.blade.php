                            ...
                            <h3 class="card-title"> Subir Imagenes </h3>
                                <form enctype="multipart/form-data" action="{{ route('gallery.store') }}" method="POST">
                                    ...
                                    <div class="form-group d-flex">
                                        <input type="text" name="name" value="" class="form-control" id="inputName" name="nombre">
                                        <input id="inputId" type="text" readonly name="id_product" value="" class="form-control">
                                    </div>
